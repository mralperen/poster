...
export function InfoPage({
  ...
  return (
    <main className="bg-[#09090a] text-white">
      <section className="bg-[linear-gradient(180deg,rgba(255,255,255,0.05),transparent)] px-4 pt-12 pb-2 sm:px-6 sm:pt-16">
        <div className="mx-auto max-w-5xl">
          ...
          {title ? (
            ...
            <h1 className="mt-8 text-xs font-semibold tracking-[0.24em] text-amber-300 uppercase">
              {eyebrow}
            </h1>
          )}
        </div>
